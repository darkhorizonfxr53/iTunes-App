...
// This function is exactly the same as the one above except this one does not interact with the frontend to get the term and media, but has instead been hard coded. 
//Using an exact copy of function above, but with hard coded term and media values helps to test the endpoints of the search.
